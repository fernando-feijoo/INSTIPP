 ...
 */
package ActividadClase_03092021_Interfaz_calculadora;
...
public class calculadora extends javax.swing.JFrame {
    double total, extra, captura; int id = 0, c = 1, idAx1 = 0, idAx2 = 0;
    String captura1;
    /**
    ...
    private void btn_igualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_igualActionPerformed
        // TODO add your handling code here:
        captura = Double.parseDouble(txf_resultado.getText());
        if(c == 2)
        {
            idAx2 = id;
            id = idAx1;
        ...
        System.out.println(id + ", " + idAx1 + ", " + idAx2 + " c " + c);
        OP(id, captura);
        c = 1;
    ...
    public void OP(int id, double captura)
    {
        switch (id) 
        {
            case 1:
