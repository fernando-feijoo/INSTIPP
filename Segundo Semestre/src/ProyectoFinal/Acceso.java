...
public class Acceso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(241, 233, 228));

        lbl_Cerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ProyectoFinal/cancelar.png"))); // NOI18N
        ...
        jPanel2.setBackground(new java.awt.Color(241, 233, 228));

        lbl_InicioSesion.setBackground(new java.awt.Color(51, 51, 51));
        lbl_InicioSesion.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        lbl_InicioSesion.setForeground(new java.awt.Color(51, 51, 51));
        ...
        btn_Entrar.setBackground(new java.awt.Color(255, 153, 255));
        ...
        lbl_Validador.setForeground(new java.awt.Color(255, 102, 102));
        lbl_Validador.setAlignmentX(0.5F);

        lbl_FotoUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ProyectoFinal/usuario.png"))); // NOI18N

        lbl_FotoPassword.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ProyectoFinal/contrasena.png"))); // NOI18N

        lbl_FotoEscudoPolicia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ProyectoDeClase/cuenta 128px.png"))); // NOI18N
    ...
    public void validacion() 
    {
        ...
        char[] array = psf_Password.getPassword();
        String pass = new String(array);
        if (txf_Usuario.getText().equalsIgnoreCase("") || pass.equals(""))
        {
            JOptionPane.showMessageDialog(this,"Error ingrese datos");
        }else
        {
            try 
            {
                ...
                ResultSet rs = st.executeQuery("SELECT usuario, contrasena FROM public.validacion WHERE usuario = '"+txf_Usuario.getText()+"';");                   
                while (rs.next()) 
                {
                ...
                st.close();
                BaseDatos.close();
                System.out.println(txf_Usuario.getText().equalsIgnoreCase(datos[0]));
                if (txf_Usuario.getText().equalsIgnoreCase(datos[0]) && pass.equals(datos[1]))
                {
                    dispose();
                    p1.show();
